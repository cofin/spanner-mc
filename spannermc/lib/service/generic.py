...
class Service(Generic[T]):
    ...
    __id__: ClassVar[str] = "spannermc.lib.service.generic.Service"
    ...
    def create(self, data: T | dict[str, Any]) -> T:
    ...
    def create_many(self, data: list[Any] | list[dict[str, Any]]) -> Sequence[T]:
    ...
    def update(self, item_id: Any, data: T | dict[str, Any]) -> T:
    ...
    def update_many(self, data: list[Any] | list[dict[str, Any]]) -> Sequence[T]:
    ...
    def upsert(self, item_id: Any, data: T) -> T:
    ...
    def get_or_create(self, match_fields: list[str] | None = None, **kwargs: Any) -> tuple[T, bool]:
        ...
        Returns:
            Representation of instance with identifier `item_id`.
        """
        return self.to_model(**kwargs), False
    ...
    def to_model(self, data: T | dict[str, Any], operation: str | None = None) -> T:
    ...
    def list(self, **kwargs: Any) -> Sequence[T]:
    ...
    def list_and_count(self, **kwargs: Any) -> tuple[Sequence[T], int]:
        ...
        """
        collection = self.list(**kwargs)
        count = self.count(**kwargs)
        return collection, count

    @classmethod
    @contextlib.contextmanager
    def new(cls: type[ServiceT]) -> Iterator[ServiceT]:
