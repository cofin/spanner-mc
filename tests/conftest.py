...
def fx_app(pytestconfig: pytest.Config, monkeypatch: MonkeyPatch) -> Litestar:
    ...
    """
    from spannermc.asgi import create_app
...
def fx_cap_logger(monkeypatch: MonkeyPatch) -> CapturingLogger:
    ...
    import spannermc.lib

    spannermc.lib.log.configure(
        spannermc.lib.log.default_processors  # type:ignore[arg-type]
    )
    # clear context for every test
    clear_contextvars()
    # pylint: disable=protected-access
    logger = spannermc.lib.log.controller.LOGGER.bind()
